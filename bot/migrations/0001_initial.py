    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, help_text="Konkurs uchun to'lov narxi", max_digits=10, verbose_name='Konkurs narxi')),
                ('start_date', models.DateField(help_text='Konkurs boshlanish sanasi ($MM/DD/YYYY)', verbose_name='Boshlanish sanasi')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Yaratilgan sana')),
                ('max_participants', models.PositiveIntegerField(blank=True, help_text="Konkursga maksimal ishtirokchilar soni (bo'sh bo'lsa cheksiz)", null=True, verbose_name='Maksimal ishtirokchilar soni')),
                ('winner_count', models.PositiveIntegerField(default=1, help_text="Konkursda g'olib bo'luvchilar soni", verbose_name="G'oliblar soni")),
                ('konkurs_mandatory_channels', models.ManyToManyField(blank=True, help_text='Konkurs uchun majburiy kanallar', related_name='konkurslar', to='bot.mandatorychannel', verbose_name='Majburiy kanallar')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Yaratilgan sana')),
                ('konkurs', models.ForeignKey(help_text='Bu yopiq kanal qaysi konkurs uchun', on_delete=django.db.models.deletion.CASCADE, related_name='private_channels', to='bot.konkurslar', verbose_name='Konkurs')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('konkurs', models.ForeignKey(blank=True, help_text="To'lov qilingan konkurs", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='bot.konkurslar', verbose_name='Konkurs')),
        ...
        migrations.CreateModel(
            name='KonkursParticipant',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('joined_date', models.DateTimeField(auto_now_add=True, help_text="Konkurs ishtirokchisi qo'shilgan sana", verbose_name="Qo'shilgan sana")),
                ('private_channel_invited', models.BooleanField(default=False, help_text='Konkurs ishtirokchisi yopiq kanalga taklif qilinganmi', verbose_name='Yopiq kanalga taklif qilingan')),
                ('referral_link', models.CharField(blank=True, help_text='Konkurs ishtirokchisi uchun referal havola', max_length=255, null=True, verbose_name='Referal havola')),
                ('konkurs', models.ForeignKey(help_text='Konkurs ishtirokchisi konkursi', on_delete=django.db.models.deletion.CASCADE, related_name='konkurs_participants', to='bot.konkurslar', verbose_name='Konkurs')),
                ('payment', models.OneToOneField(help_text="Konkurs ishtirokchisi to'lovi", on_delete=django.db.models.deletion.CASCADE, related_name='konkurs_participant_payments', to='bot.payments', verbose_name="To'lov")),
                ('user', models.ForeignKey(help_text='Konkurs ishtirokchisi foydalanuvchisi', on_delete=django.db.models.deletion.CASCADE, related_name='konkurs_participants_users', to='bot.telegramuser', verbose_name='Foydalanuvchi')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='payments',
            index=models.Index(fields=['user', 'konkurs'], name='bot_payment_user_id_6220a9_idx'),
        ),
        migrations.AddIndex(
            model_name='payments',
