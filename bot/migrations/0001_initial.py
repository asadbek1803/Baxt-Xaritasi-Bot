# Generated by Django 5.2.2 on 2025-08-10 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('level_0', '0-bosqich'), ('level_1', '1-bosqich'), ('level_2', '2-bosqich'), ('level_3', '3-bosqich'), ('level_4', '4-bosqich'), ('level_5', '5-bosqich'), ('level_6', '6-bosqich'), ('level_7', '7-bosqich')], default='0-bosqich', help_text='Foydalanuvchi darajasi', max_length=20, verbose_name='Foydalanuvchi darajasi')),
                ...
                ('card_number', models.CharField(blank=True, help_text='Foydalanuvchining plastik karta raqami', max_length=20, null=True, verbose_name='Plastik karta raqami')),
                ('card_holder_full_name', models.CharField(blank=True, help_text="Foydalanuvchining karta egasining to'liq ismi", max_length=200, null=True, verbose_name="Karta egasining to'liq ismi")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Kutilmoqda'), ('CONFIRMED', 'Tasdiqlangan'), ('REJECTED', 'Rad etilgan')], default='PENDING', max_length=20, verbose_name='Holati')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('confirmed_at', models.DateTimeField(blank=True, null=True)),
                ('confirmed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='confirmed_referral_payments', to='bot.telegramuser', verbose_name='Tasdiqlovchi')),
                ('referrer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_payments_received', to='bot.telegramuser', verbose_name='Referral egasi')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referral_payments_made', to='bot.telegramuser', verbose_name="To'lovchi")),
            ],
            options={
